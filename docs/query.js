...
[
  {
    $match:
       ...
       */
      {
        ...
        $or: [
          {
            "data.en.mitral_regurgitation_1": "Present",
            "data.en.mitral_regurgitation_stage": {
              $in: ["A At risk of MR", "B Progressive"],
            }
          },
          {
            "data.en.mitral_stenosis": "Present",
            "data.en.mitral_stenosis_stage":
              "A At rick for MS",
          },
          {
            "data.en.aortic_valve": {
              $in: ["Consolidated", "Calcification"],
            },
          },
          {
            "data.en.aortic_regurgitation": "Present",
          ...
          {
            "data.en.aortic_stenosis": "Present",
          ...
          {
            "data.en.valve_prostheses": "Present"
          },
          {
